  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col w-full h-full items-center justify-center overflow-hidden">
        {/* 上部分：照片 + 基本信息（3/5 高度） */}
        <div className="flex-[3.2] flex gap-12 pb-8 border-b border-white/30 items-center justify-center w-full">
        ...
        <div className="flex-[1.8] flex gap-12 pt-2 mt-0 overflow-y-auto justify-between w-full">
